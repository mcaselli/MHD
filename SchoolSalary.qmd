...
plot_sal_pci <- rev_inc_sal %>%
  ...
  geom_text_repel(data=rev_inc_sal %>% filter(!ns_peer),
                  aes(x=DOR.Income.Per.Capita, y=Average.Salary, label=Municipality), color = "#666666") +
  ...
  # geom_label_repel() +
  scale_color_manual(values = c(MHD="#F8766D", ns_peer="#00BFC4", other="#333333")) +
...
ggsave(here("figures", "sal_vs_pci.jpeg"), plot_sal_pci, width = 3.3, height = 3.3,
       units = "in", dpi=200, scaling=0.8)
ggsave(here("figures", "sal_vs_pci.png"), plot_sal_pci, width = 3.3, height = 3.3,
       units = "in", dpi=200, scaling=0.8)
ggsave(here("figures", "sal_vs_pci.pdf"), plot_sal_pci, width = 3.3, height = 3.3,
       units = "in", dpi=200)
