...
```{r}
rev_inc_sal%>%
  filter(Municipality %in% c("Swampscott", "Marblehead") | pci_peer) %>%
  select(Municipality, DOR.Income.Per.Capita, Average.Salary, per_capita_receipts,
