...
Marblehead's per capita tax receipts are `r label_dollar()(mhd_pc_receipts)`, 
...
dat %>%
  ...
  annotate(geom="label", x=140e3, y=peer_median_pc_receipts, label="Median of Peer Group") +
  scale_x_continuous(labels=label_dollar()) +
  scale_y_continuous(labels=label_dollar()) +
